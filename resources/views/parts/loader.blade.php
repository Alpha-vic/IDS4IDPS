<div id="{{$loader_id or 'loader'}}" style="display: none" class="center-align {{$loader_classes or 'padding-top-2em'}}">
    ...
    <p class="center-align no-margin {{$loader_font or 'font-lg grey-text'}}">{!!$loader_text or 'Loading...'!!}</p>
    @endif
</div>
